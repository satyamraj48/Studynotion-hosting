...
function MyProfile() {
	...
	return (
		<div className="w-11/12 mx-auto max-w-[1000px] py-10 text-richblack-5 tracking-wide">
			...
			{/* section 1 */}
			<section>
				<div className=" px-12 py-8 bg-richblack-800 rounded-lg my-10 flex items-center justify-between gap-6 border border-richblack-700 ">
			...
			<section>
				<div className="px-12 py-8 bg-richblack-800 rounded-lg my-10 flex flex-col gap-10 border border-richblack-700">
					...
					<div className="flex max-w-[500px] flex-row justify-between text-sm">
