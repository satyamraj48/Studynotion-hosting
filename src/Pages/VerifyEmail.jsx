		...
		<div className="flex min-h-[calc(100vh-6rem)] items-center justify-center text-white">
			<div className="max-w-[500px] p-4 lg:p-8 ">
				...
				<form onSubmit={handleOnSubmit} className="">
					...
					<button
						type="submit"
						className="bg-yellow-50 w-full text-lg font-medium text-richblack-900 mt-7 p-[12px] py-[10px] rounded-lg"
					>
						{!loading ? (
							"Verify Email"
						) : (
							<div className="mx-auto !w-7 !h-7 !border-black spinner2"></div>
						)}
					</button>
				</form>
